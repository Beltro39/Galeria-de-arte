      ...
      <div class="form-group">
                       ...
                       <div class="form-group">
                            ...
                            <div class="form-group" style="display: none">
                                <input type="text" name="codigorecibo2" id="codigorecibo2" class="form-control" value=<?php echo $_POST["codigorecibo"];  ?>>
                            </div>    
      </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text" value=<?=$_POST["codigorecibo"];?> hidden>
                                    <input type="text" name="p" value=<?=$_POST["codigorecibo"];?> hidden>
